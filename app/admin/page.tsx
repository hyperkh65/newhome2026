...
const SPEC_FIELDS = [
  ...
  { key: 'cct', label: '색온도 옵션', unit: '', icon: '🌈' },
  { key: 'color_temp', label: '색온도(대표)', unit: 'K', icon: '🌡' },
  { key: 'cri', label: '연색지수 CRI', unit: 'Ra', icon: '🎨' },
  { key: 'beam_angle', label: '배광각', unit: '°', icon: '📐' },
  { key: 'flux_tolerance', label: '광속 오차', unit: '', icon: '±' },
  // LED 칩
  { key: 'chip_type', label: '칩 종류', unit: '', icon: '🔬' },
  { key: 'chip_qty', label: '칩 수량', unit: '개', icon: '🔢' },
  // 구조/소재
  { key: 'product_type', label: '제품 타입', unit: '', icon: '📦' },
  { key: 'size', label: '외형 크기', unit: 'mm', icon: '📏' },
  { key: 'weight', label: '중량', unit: 'g', icon: '⚖️' },
  { key: 'material', label: '소재', unit: '', icon: '🧱' },
  { key: 'body_color', label: '바디 색상', unit: '', icon: '🎨' },
  { key: 'connection_type', label: '접속 방식', unit: '', icon: '🔗' },
  // 환경/안전
  { key: 'ip_rating', label: 'IP 등급', unit: '', icon: '🛡️' },
  { key: 'operating_temp', label: '작동온도', unit: '°C', icon: '🌡️' },
  { key: 'dimming', label: '디밍', unit: '', icon: '🔆' },
  // 수명/보증
  { key: 'lifespan', label: '수명', unit: 'h', icon: '⏱️' },
  { key: 'warranty', label: '보증기간', unit: '', icon: '🛡' },
  { key: 'switching_cycles', label: '스위칭 횟수', unit: '', icon: '🔄' },
  // 드라이버
  { key: 'driver', label: '드라이버 타입', unit: '', icon: '🔧' },
  { key: 'driver_brand', label: '드라이버 브랜드', unit: '', icon: '🏷️' },
  // 포장/물류
  { key: 'pcs_per_carton', label: '박스당 수량', unit: '개', icon: '📦' },
  { key: 'gift_box_size', label: '낱개박스 크기', unit: 'mm', icon: '📫' },
  { key: 'carton_size', label: '외박스 크기', unit: 'mm', icon: '🗃️' },
  { key: 'packaging_type', label: '포장 방식', unit: '', icon: '🎁' },
  // 구매/공급
  { key: 'moq', label: 'MOQ', unit: '개', icon: '📋' },
  { key: 'lead_time', label: '납기', unit: '', icon: '🚢' },
...
export default function AdminPage() {
  ...
  if (tab === 'quotation') {
    return (
      <div className="quotation-overlay" style={{ position: 'fixed', inset: 0, zIndex: 1000, background: '#fff', overflowY: 'auto' }}>
        <div className="quotation-back-btn" style={{ position: 'fixed', top: 10, left: 10, zIndex: 1100 }}>
  ...
  const NAV_ITEMS = [
    ...
    { key: 'quotation',  label: '견적 의뢰서',  icon: '📄', badge: null },
  ];
