...
export default function BoardPage() {
  ...
  return (
    <div style={{ background: '#f8fafc', minHeight: '100vh' }}>
      ...
      <main className="board-page" style={{ maxWidth: 960, margin: '0 auto', padding: '100px 24px 80px' }}>
        ...
        {!selected && (
          <div style={{ background: '#fff', borderRadius: 20, overflow: 'hidden', border: '1px solid #e2e8f0', boxShadow: '0 4px 24px rgba(0,0,0,0.04)' }}>
            {/* 헤더 행 */}
            <div className="board-list-row" style={{ display: 'grid', gridTemplateColumns: '60px 1fr 110px 130px', padding: '13px 24px', background: '#f8fafc', borderBottom: '2px solid #e2e8f0' }}>
