...
export const TRANSLATIONS: Record<string, Record<Language, string>> = {
  ...
  market: { ko: '시장현황', en: 'Market', zh: '市场动态', ja: '市場動向' },
  hscode: { ko: 'HS코드', en: 'HS Code', zh: 'HS编码', ja: 'HSコード' },
  market_report: { ko: '시장보고서', en: 'Market Reports', zh: '市场报告', ja: '市場レポート' },
  support: { ko: '고객센터', en: 'Support', zh: '客户中心', ja: 'カスタマーサポート' },
  learning: { ko: '학습실', en: 'Learning Lab', zh: '学习中心', ja: '学習室' },
  faq: { ko: '자주 묻는 질문', en: 'FAQ', zh: '常见问题', ja: 'よくある質問' },
  inquiries: { ko: '고객문의', en: 'Contact Us', zh: '客户咨询', ja: 'お問い合わせ' },
  install_guide: { ko: '설치가이드', en: 'Installation Guide', zh: '安装指南', ja: '設置ガイド' },
  as_request: { ko: 'A/S 신청', en: 'Service Request', zh: '售后申请', ja: '修理申請' },
  faq_desc: { ko: '자주 묻는 질문 모음', en: 'Frequently asked questions', zh: '常见问题汇总', ja: 'よくある質問' },
  contact_desc: { ko: '제품 문의 및 견적 요청', en: 'Product questions and quotations', zh: '产品咨询与报价请求', ja: '製品相談・見積依頼' },
  install_desc: { ko: '제품 설치 영상 가이드', en: 'Product installation videos', zh: '产品安装视频指南', ja: '製品設置動画ガイド' },
  as_desc: { ko: '수리 및 교체 접수', en: 'Repair and replacement requests', zh: '维修与更换申请', ja: '修理・交換受付' },
  market_status: { ko: '시장 현황 · 원자재 시세', en: 'Market & Raw Material Prices', zh: '市场动态 · 原材料价格', ja: '市場動向・原材料価格' },
  about_title: { ko: '회사 소개', en: 'About Us', zh: '公司介绍', ja: '会社紹介' },
  location: { ko: '회사 위치 / 오시는 길', en: 'Location & Directions', zh: '公司位置 / 交通指南', ja: '所在地・アクセス' },
  trade_title: { ko: '무역·인증 안내', en: 'Trade & Certification Guide', zh: '贸易与认证指南', ja: '貿易・認証ガイド' },
  tracking_title: { ko: '물류 조회', en: 'Shipment Tracking', zh: '物流查询', ja: '物流照会' },
  board_title: { ko: '자료 공유 게시판', en: 'Resource Board', zh: '资料共享公告栏', ja: '資料共有掲示板' },
  blog_title: { ko: '블로그', en: 'Blog', zh: '博客', ja: 'ブログ' },
  report_title: { ko: '시장 보고서', en: 'Market Reports', zh: '市场报告', ja: '市場レポート' },
  catalog_title: { ko: '전자 카탈로그', en: 'Digital Catalogs', zh: '电子目录', ja: '電子カタログ' },
  search_results: { ko: '검색 결과', en: 'Search Results', zh: '搜索结果', ja: '検索結果' },
  contact_title: { ko: '고객 문의', en: 'Contact Us', zh: '客户咨询', ja: 'お問い合わせ' },
  faq_title: { ko: '자주 묻는 질문', en: 'Frequently Asked Questions', zh: '常见问题', ja: 'よくある質問' },
  guide_title: { ko: '설치 가이드', en: 'Installation Guide', zh: '安装指南', ja: '設置ガイド' },
  data_sources: { ko: '데이터 출처', en: 'Data Sources', zh: '数据来源', ja: 'データソース' },
  procurement: { ko: '조달시장', en: 'Public Procurement', zh: '公共采购市场', ja: '調達市場' },
  consumer: { ko: '민수시장', en: 'Private Market', zh: '民用市场', ja: '民需市場' },
  company_list: { ko: '업체 목록', en: 'Company Directory', zh: '企业列表', ja: '企業一覧' },
  save: { ko: '저장', en: 'Save', zh: '保存', ja: '保存' },
  close: { ko: '닫기', en: 'Close', zh: '关闭', ja: '閉じる' },
  download: { ko: '다운로드', en: 'Download', zh: '下载', ja: 'ダウンロード' },
  password_prompt: { ko: '열람 암호 입력', en: 'Enter access password', zh: '请输入访问密码', ja: '閲覧パスワードを入力' },
  no_results: { ko: '검색 결과가 없습니다', en: 'No results found', zh: '没有找到结果', ja: '検索結果がありません' },
};
