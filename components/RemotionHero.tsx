  ...
  return (
    <AbsoluteFill style={{ justifyContent: 'center', alignItems: 'center', padding: '40px 24px', background: 'transparent' }}>
      <div style={{
        ...
        <div style={{ opacity: phase2, transform: `translateY(${translateY(phase2)}px)` }}>
          <h1 style={{
            fontSize: 'clamp(34px, 7vw, 100px)', fontWeight: 950,
            color: '#ffffff', letterSpacing: '-0.05em', lineHeight: 1.05,
            textShadow: '0 15px 45px rgba(0,0,0,0.6)', marginBottom: 0,
            ...
            <span style={{
              ...
              fontWeight: 950, filter: 'drop-shadow(0 2px 4px rgba(0,0,0,0.3))',
            }}>신뢰할 수 있는 공급</span>
          </h1>
        </div>

        <div style={{ opacity: phase3, transform: `translateY(${translateY(phase3)}px)`, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 32 }}>
          ...
          <p style={{
            ...
            textShadow: '0 2px 10px rgba(0,0,0,0.5)', WebkitFontSmoothing: 'antialiased',
          }}>
        ...
        <div style={{ opacity: phase4, transform: `translateY(${translateY(phase4)}px)`, display: 'flex', gap: 16, flexWrap: 'wrap', justifyContent: 'center', marginTop: 8, pointerEvents: 'auto' }}>
          <a href="/shop" style={{
